...
Thus, the omitted-variable model is expected to converge toward $1.6$, not toward the true coefficient $1.0$.
...
The experiment is designed to separate **sampling variation** from **structural misspecification**.
